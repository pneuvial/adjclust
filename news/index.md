...
- Update github test coverage workflow to v4
  ([\#84](https://github.com/pneuvial/adjclust/issues/84))
- Fix for upcoming “testthat” 3.3 release
  ([\#83](https://github.com/pneuvial/adjclust/issues/83))

## Version 0.6.10 \[2024-10-07\]

CRAN release: 2024-10-08

- Bug fix on OMP option
  ([\#81](https://github.com/pneuvial/adjclust/issues/81))

## Version 0.6.9 \[2024-02-07\]

CRAN release: 2024-02-08

- Properly handled OMP threads in C++ code (now default to 1 but with an
  option to increase this value)
...
- Fix [\#60](https://github.com/pneuvial/adjclust/issues/60) (increase
  test coverage)
- Fix [\#61](https://github.com/pneuvial/adjclust/issues/61) (NAMESPACE
  error in ‘snpClust.matrix’)
- Fix [\#45](https://github.com/pneuvial/adjclust/issues/45) (update
  ‘calls’ for ’adjclust.\*’ methods)
- Fix [\#49](https://github.com/pneuvial/adjclust/issues/49) (calls to
  ‘library’ in tests)
- Fix [\#55](https://github.com/pneuvial/adjclust/issues/55) (pkgdown
  action)
- Fix [\#40](https://github.com/pneuvial/adjclust/issues/40) (moved
  plotSim to a ‘ggplot2’ version)
- Fix [\#30](https://github.com/pneuvial/adjclust/issues/30) (improved
  plotSim, k and correct have been added as new arguments)
- Fix [\#62](https://github.com/pneuvial/adjclust/issues/62) (citation
  file corrected)
- Fix [\#68](https://github.com/pneuvial/adjclust/issues/68) (CRAN note)
...
- Code improvement: replaced `class( ) !=` by equivalent expression
  using [`inherits( )`](https://rdrr.io/r/base/class.html)
...
- Increase in speed by code optimization and by using RcppArmadillo
  (update by Gabriel Hoffman), at least for linux machines (uses OpenMP)
...
- Updated citation in DESCRIPTION and man files (almob paper) and added
  a CITATION file.
...
- Fixed Issue [\#35](https://github.com/pneuvial/adjclust/issues/35)
  (probably due to a change in the upstream snpStats package).
- Added a test on plotSim.
- Changed test on NA in snpStats package (probably due to a change in
  the upstream snpStats package) and fixed Issue
  [\#43](https://github.com/pneuvial/adjclust/issues/43).
...
- implemented a model selection approach based on slope heuristic or on
  the broken stick heuristic to select a relevant number of clusters
...
- Removed non-standard fields in the output of ‘adjclust’
  ([\#13](https://github.com/pneuvial/adjclust/issues/13)).
- Added tests for: equivalence with ‘hclust’, comparing sum of heights
  and pseudo inertia, plots, non-increasing heights, cutree
  ([\#14](https://github.com/pneuvial/adjclust/issues/14)).
- Fixed [\#13](https://github.com/pneuvial/adjclust/issues/13) (man).
- Fixed [\#15](https://github.com/pneuvial/adjclust/issues/15) (cutree
  with decreasing merges).
- Fixed [\#3](https://github.com/pneuvial/adjclust/issues/3)
  (Non-positive ‘gains’).
...
- Cleaned up code to improve efficiency and removed unnecessary scripts
  and functions
...
- “Fixed” warning at check due to .hpp file in src (this warning should
  not exist IMHO)
