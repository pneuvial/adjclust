...
```
The result is not an object of type 'hclust', but it does contain the successive merges of the clustering, and the improvement in the criterion optimized by the clustering at each successive merge:
