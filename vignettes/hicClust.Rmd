...
# Loading a sample Hi-C contact map
...
The output is of class `hclust`. In particular, it can be plotted as a dendrogram:

```{r}
plot(fitB, labels=FALSE, hang=-1, ann=FALSE)
```
...
[1] Dixon, Jesse R., *et al* (2012). "Topological domains in mammalian genomes identified by analysis of chromatin interactions." Nature 485.7398 (2012): 376.
...
[3] Servant N., *et al* (2012). HiTC : Exploration of High-Throughput 'C' experiments. Bioinformatics
