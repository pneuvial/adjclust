...
obtained from the `HiTC` package [3]. It is a contact map corresponding to 
chromosome X vs chromosome X. 
...
The output is of class `hclust`. In particular, it can be plotted as a 
dendrogram:
