...
In this short vignette we demonstrate the use of `adjClust` function in the `adjclust` package to perform adjacency-constrained hierarchical clustering of Linkage Disequilibrium data.
...
```{r}
fit <- adjClust(ld.ceph, "similarity", h, blMin=1)
```
