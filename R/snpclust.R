...
#' 
#' \code{snpclust} performes constrained hierarchichal agglomerative clustering of single nucleotide 
...
#' @param stats A character vector specifying the linkage disequilibrium measures to be calculated. This should contain one or 
