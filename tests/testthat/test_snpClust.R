...
context("Comparison of the results of snpClust function in latest version of adjclust package with results generated by adjClustBand_heap(now renamed as adjClust) in primitive version of adjclust package")
