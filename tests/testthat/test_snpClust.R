...
context("Comparison of the results of snpClust function in latest version of adjclust package with results generated by adjClust in primitive version of adjclust package")

test_that("snpClust function gives results identical to results of adjClust in primitive version of adjclust stored in prevfit.rda", {
